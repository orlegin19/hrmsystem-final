            ...
            <div class="row page-titles">
                ...
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><i class="fa fa-university" aria-hidden="true" style="color:maroon"></i> Invoice</li>
                    </ol>
                </div>
            </div>
            <style type="text/css">
                        ...
                        <div class="modal-content ">
                            ...
                            <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="emid" class="form-control" id="recipient-name1" value="<?php echo $obj_merged->em_code; ?>" readonly>
                                    </div>                                         
                                    <div class="form-group">
