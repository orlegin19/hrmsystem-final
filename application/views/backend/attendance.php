         ...
         <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor"><i class="fa fa-calendar-check-o" style="color:maroon"></i> Attendance</h3>
                </div>
                    ...
                    <div class="col-12">
                        <div class="card card-outline-info">
                            <div class="card-header">
                                <h4 class="fa fa-calendar-check-o"> Attendance List  </h4>
                            </div>
                            <div class="card-body">
                                        ...
                                        <tbody>
                                           <?php foreach($attendancelist as $value): ?>
                                            <tr>
                                                ...
                                                <td><?php echo $value->signin_time; ?> AM</td>
                                                <td><?php 
												echo $value->signout_time;  ?> PM</td>
                                                <td><?php if($value->signout_time == '00:00:00') {
															echo '0';
												} else {  echo $value->Hours; } ?></td>
                                                <td class="jsgrid-align-center ">
                                                <?php if($value->signout_time == '00:00:00') { ?>
                                                    <a href="Save_Attendance?A=<?php echo $value->id; ?>" title="Edit" class="btn btn-sm btn-success waves-effect waves-light" data-value="Approve" >Sign Out</a><br>                           
                                                <?php } ?>
                                                 ...
                                                 <a href="DeletAttendance?D=<?php echo $value->id; ?>" onclick="confirm('Are you sure to delete this data?')" title="Delete" class="btn btn-sm btn-danger waves-effect waves-light"><i class="fa fa-trash-o"></i></a>
												</td>
                                            </tr>
                                            <?php endforeach; ?>
                                        </tbody>
