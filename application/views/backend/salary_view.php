...
<div class="page-wrapper">
  ...
  <div class="row page-titles">
    <div class="col-md-5 align-self-center">
      <h3 class="text-themecolor"><i class="fa fa-money" style="color:maroon"></i> Payroll View
      </h3>
    </div>
      ...
      <div class="col-12">
        <div class="card card-outline-info">
          <div class="card-header">
            <h4 class="fa fa-money"> Monthly Payroll List
            </h4>
          </div>
          <div class="card-body">
            ...
            <!--Savd vdgff gdfg dfg dfgdfg df  gd gdd gfd-->
			<input name="b_print" type="button" class="btn btn-info print_salary_btn"  value=" Print ">
            <div class="table-responsive print_salary">
              <table id="generatesal" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                <thead>
                  <tr>
                    <th>PIN 
                    </th>
		...
		<script>
			$(document).ready(function() {
				$(".print_salary_btn").click(function() {
					...
					$("div.print_salary").printArea(options);
				});
			});
		</script>