            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="fa fa-calendar-check-o"> Attendance Report</h4>
				...
				<span class="gby">Generated by:<p style="text-decoration:underline;"><?php echo $basicinfo->first_name." ".$basicinfo->last_name; ?></p></span>
            </div>
			
            <button type='button' class='btn btn-primary print_attendance_btn' id='print_payslip_btn'><i class='fa fa-print'></i><i class='' aria-hidden='true' onclick='printDiv()'></i>  Print</button> 
<?php $this->load->view('backend/footer'); ?>
<script src="<?php echo base_url(); ?>assets/js/jquery.PrintArea.js" type="text/JavaScript"></script>
<script type="text/javascript">
    $(document).ready(function() {
		 $('.print_attendance_btn').hide();
		 $('.gby').hide();
    ...
    $(document).ready(function() {
        $(".print_attendance_btn").click(function() {
            console.log('sfsdfs');
            ...
            $("div.attendancer").printArea(options);
        });
    });
