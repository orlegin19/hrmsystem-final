...
<?php $this->load->view('backend/sidebar'); ?>
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor"><i class="fa fa-users" style="color:maroon"></i> <?php echo $basic->first_name .' '.$basic->last_name; ?></h3>
                </div>
                ...
                <?php $schedvalue = $this->employee_model->getschedule(); ?>
                            ...
                            <div class="card-body"> <small class="text-muted">Email address </small>
                                ...
                                <a class="btn btn-circle btn-secondary" href="<?php if(!empty($socialmedia->google_Plus)) echo $socialmedia->google_Plus ?>" target="_blank"><i class="fa fa-google"></i></a>
                                   ...
                                   <?php if(!empty($basic->em_image)){ ?>
                                    ...
                                    <?php } ?>
                                                        <label>Image </label>
                                                        <input type="file" <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?> readonly <?php } ?> name="image_url" class="form-control" value="" accept=".jpg, .jpeg, .png"> 
                                                    </div>
													<div class="form-group col-md-4 m-t-10">
				                                        <label>Working Schedule </label>
				                                         
														<select name="schedule" <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?> readonly <?php } ?> class="form-control custom-select">
				                                            <option value="<?php echo $basic->id; ?>"><?php echo $basic->time_in.'-'.$basic->time_out; ?></option>
                                            <?Php foreach($schedvalue as $value): ?>
                                             <option value="<?php echo $value->id ?>"><?php echo $value->time_in.'-'.$value->time_out ?></option>
                                            <?php endforeach; ?>
				                                        </select>
												   </div>
                                                    <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?>
