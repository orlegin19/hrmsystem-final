...
<head>
    ...
    <meta name="author" content="MCC IT Capstone">
    <!-- Favicon icon -->
    <?php $settingsvalue = $this->settings_model->GetSettingsValue(); ?>
    <link rel="icon" type="image/jpg" sizes="16x16" href="<?php echo base_url(); ?>assets/images/favicn.jpg">
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                <div class="navbar-header">
                    <a class="navbar-brand" href="<?php echo base_url(); ?>"><b>
                        <img src="<?php echo base_url();?>assets/images/four.jpg" alt="DRI" class="DRI-logo" style="width:80px;"/>
                        </b>
                        <!-- Logo text --><span>
