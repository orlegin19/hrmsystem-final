         ...
         <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor"><i class="fa fa-university" aria-hidden="true" style="color:maroon"></i> Invoice</h3>
                </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                        <li class="breadcrumb-item active"><a ria-hidden="true"></i> Invoice</li>
                    </ol>
                </div>
            </div>
            <style type="text/css">
            ...
            <div class="container-fluid">
                <div class="row m-b-10"> 
                    <div class="col-12">
                       <!--<button type="button" class="btn btn-info"><i class="fa fa-plus"></i><a data-toggle="modal" data-target="#Salarymodel" data-whatever="@getbootstrap" class="text-white Salarymodel"><i class="" aria-hidden="true"></i> Add Payroll </a></button>-->
                        ...
                        <div class="card card-body">
                            <div class="row">
                                <div class="col-md-4 col-xs-6 col-sm-6">
                                    <img src="<?php echo base_url();?>assets/images/jam.jpg" style=" width:250px; height:80px; margin-right: 10px;" />
                                </div>
                                ...
                                <div class="col-md-12"><!-- 
                                    ...
                                    <table class="table table-condensed borderless payslip_info">
                                        ...
                                        <tr>
                                            ...
                                            <td>: 
                                                <?php
                                                   //$days = ceil($salary_info->total_days / 10);
                                                   echo $days;
                                                ?>
                                            </td>-->
                                    ...
                                    <table class="table table-condensed borderless" style="border-left: 1px solid #ececec;">
                                        ...
                                        <tbody style="border: 1px solid #ececec;">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center"><?php echo $salary_info->total_days; ?> hrs</td>
                                                <!--<td class="text-right">
                                                    <?php
                                        ...
                                        <tfoot class="tfoot-light">
                                            <tr>
                                                <th>Rate Per Hour</th>
                                                <th class="text-center"> ₱ <?php $total_add = $salary_info->basic / 360; echo round($total_add,2); ?></th>
                                            ...
                                            <tr>
                                                ...
                                                <th class="text-center">₱ <?php echo $salary_info->total_pay/*round($total_add - $total_did,2)*/; ?></th>
                                            </tr>
                                        </tfoot>
                                    </table>
                                </div>
                            ...
                            <div class="row">
                                    ...
                                    <div class="table-responsive" style="clear: both;">
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>Basic Salary</td>
                                                    <td class="text-right"> <?php echo $salaryvaluebyid->basic;?> PHP</td>
                                                    <td class="text-right">  </td>
                                                </tr>
                                                <tr>
                                                    <td>Madical</td>
                                                    <td class="text-right"> <?php echo $salaryvaluebyid->medical;?> PHP </td>
                                                    <td class="text-right">  </td>
                                                </tr>
                                                <tr>
                                                    <td>House Rent</td>
                                                    <td class="text-right"> <?php echo $salaryvaluebyid->house_rent;?> PHP </td>
                                                    <td class="text-right">  </td>
                                                </tr>
                                                <tr>
                                                    <td>Conveyance</td>
                                                    <td class="text-right"> <?php echo $salaryvaluebyid->conveyance;?> PHP </td>
                                                    <td class="text-right">  </td>
                                                </tr>
                                                <tr>
                                                    <td>Loan</td>
                                                    <td class="text-right"> </td>
                                                    <td class="text-right"><?php echo $salary_info->loan;?>  PHP</td>
                                                </tr>
                                            </tbody>
                                            <tfoot>
                                                <tr>
                                                    <th>Total</th>
                                                    <th class="text-right"><?php echo $salaryvaluebyid->total;?> PHP</th>
                                                    <th class="text-right"><?php echo $salary_info->diduction;?>  PHP</th>
                                                </tr>
                                            </tfoot>
                                        </table>
                                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="pull-right m-t-30 text-right">
                                        <h3><b>Total :</b>  <?php echo $salary_info->total_pay;?> PHP</h3>
                                    </div>
