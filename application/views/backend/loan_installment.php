      ...
      <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor"><i class="fa fa-money"></i> Loan Installment</h3>
                </div>
                                           ...
                                           <?php foreach($installment as $value): ?>
                                            <tr>
                                                ...
                                                <td class="jsgrid-align-center">
                                                    ...
                                                    <a href="DeletLoan?D=" onclick="confirm('Are you sure to delete this value?')" title="Delet" class="btn btn-sm btn-danger waves-effect waves-light"><i class="fa fa-trash-o"></i></a>
                                                </td>
                                            </tr>
                                            <?php endforeach; ?>
                                        </tbody>
