         ...
         <div class="page-wrapper">
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor"><i class="fa fa-university" aria-hidden="true" style="color:maroon"></i> Inactive Employees</h3>
                </div>
                    ...
                    <div class="col-12">
                        <div class="card card-outline-info">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white"><i class="fa fa-user-o" aria-hidden="true"></i> Former Employee List</h4>
                            </div>
                            <div class="card-body">
                                ...
                                <!--<span class="gby">Generated by:<p style="text-decoration:underline;">Tita Cena</p></span>-->
                                    </table>
                                </div>
                            </div>
                        </div>
