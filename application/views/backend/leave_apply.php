...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-themecolor"><i class="fa fa-fighter-jet" style="color:maroon"> </i> Application</h3>
        </div>
            ...
            <div class="col-12">
                <div class="card card-outline-info">
                    <div class="card-header">
                        <h4 class="fa fa-fighter-jet"> Application List
                        </h4>
                    </div>
                    <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    <tr style="vertical-align:top">
                                        ...
                                        <td class="jsgrid-align-center">
                                            ...
                                            <a href="" title="Edit" class="btn btn-sm btn-primary waves-effect waves-light leaveapp" data-id="<?php echo $value->id; ?>" ><i class="fa fa-trash-o"></i> Delete</a>
                                            <a href="DeletLoan?D=<?php echo $value->id; ?>" onclick="confirm('Are you sure to delete this data?')" title="Delete" class="btn btn-sm btn-danger waves-effect waves-light"><i class="fa fa-trash-o"></i></a>
                                        </td>
                                        <?php } ?>
                                    </tr>
                                    <?php endforeach; ?>
                        ...
                        <div class="modal-body">
                            ...
                            <!--<div class="form-group">
                                ...
                                <div class="span pull-right">
                                    <button class="btn btn-info fetchLeaveTotal">Total Days Leave</button>
                                </div>
                                <br>
                            </div>-->
                            <div class="form-group">
