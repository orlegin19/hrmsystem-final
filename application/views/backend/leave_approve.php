...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-themecolor"><i class="fa fa-clone" style="color:maroon"> </i> Application</h3>
        </div>
                                    ...
                                    <tr style="vertical-align:top">
                                        ...
                                        <td class="jsgrid-align-center">
                                           ...
                                           <?php if($value->leave_status =='Approve'){ ?>
                                            ...
                                            <a href="DeletLeave?D=<?php echo $value->id; ?>" onclick="confirm('Are you sure to delete this data?')" title="Delete" class="btn btn-sm btn-danger waves-effect waves-light"><i class="fa fa-trash-o"></i></a>
